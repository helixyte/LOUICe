package
{
    ...
    public class LouiceConfiguration extends EverestConfiguration
    {
        ...
        public override function get modules():Vector.<Module>
        {
            ...
            res.push( new Module(ContentType.RACK_COLLECTION, 'org/helixyte/louice/modules/rackcollection/RackCollection.swf') );
        ...
        public override function get schemaMappings():Vector.<SchemaModelEntry>
        {
            ...
            res.push( new SchemaModelEntry("tube-rack", "http://schemata.thelma.org/rack", "TubeRack", TubeRackMember) );
