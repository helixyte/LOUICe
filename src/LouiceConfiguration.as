package
{
    ...
    public class LouiceConfiguration extends EverestConfiguration
    {
        ...
        public override function get modules():Vector.<Module>
        {
            ...
            res.push( new Module(ContentType.TUBERACK_COLLECTION, 'com/cenix/louice/modules/tuberackcollection/TubeRackCollection.swf') );
			res.push( new Module(ContentType.PLATE_COLLECTION, 'com/cenix/louice/modules/platecollection/PlateCollection.swf') );
