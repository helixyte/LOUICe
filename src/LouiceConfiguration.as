package
{
    ...
    import com.cenix.louice.shared.model.vos.IsoJobStockRackMember;
    ...
    import com.cenix.louice.shared.model.vos.IsoStockRackMember;
    ...
    import com.cenix.louice.shared.model.vos.StockRackMember;
    ...
    public class LouiceConfiguration extends EverestConfiguration
    {
        ...
        public override function get schemaMappings():Vector.<SchemaModelEntry>
        {
            ...
            res.push( new SchemaModelEntry("stock_rack", "http://schemata.cenix-bioscience.com/isostockrack", "StockRack", StockRackMember, "/schemata/IsoStockRack.xsd") );
            res.push( new SchemaModelEntry("iso_job_stock_rack", "http://schemata.cenix-bioscience.com/isostockrack", "IsoJobStockRack", IsoJobStockRackMember) );
            res.push( new SchemaModelEntry("iso_stock_rack", "http://schemata.cenix-bioscience.com/isostockrack", "IsoStockRack", IsoStockRackMember) );
            res.push( new SchemaModelEntry("iso_sector_stock_rack", "http://schemata.cenix-bioscience.com/isostockrack", "IsoSectorStockRack", IsoSectorStockRackMember) );
